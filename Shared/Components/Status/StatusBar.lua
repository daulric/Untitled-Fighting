...
local exon = require(ReplicatedStorage:WaitForChild("Packages"):WaitForChild("exon"))

local Component, createBinding, createElement, Children, createFragment = exon.import(exon.react) {
